...
{
    draw2D _draw_2D("average median filter");
    avg_med_filter _avg_med_filter;
    double dt = 0.01;
    double len = 10;
    ...
    for (double i = 0; i < len; i += dt)
    {
        ...
        double number_filtered = _avg_med_filter.filt(number_with_noise);
